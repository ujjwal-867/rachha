      ...
      <div className="relative w-screen max-w-full overflow-hidden">
        <div className="mx-auto max-w-5xl px-6">
          <div className="relative mx-auto max-w-4xl">
            <span className="card-bg-loop card-bg-loop-reverse pointer-events-none absolute left-0 top-0 z-0 -translate-y-10 text-[7rem] md:text-[11rem] leading-none font-serif uppercase text-royalGold/70 tracking-[0.5em] select-none whitespace-nowrap" data-text="RACHHA">
              RACHHA
            </span>

            <span className="card-bg-loop pointer-events-none absolute left-0 bottom-0 z-0 translate-y-10 text-[7rem] md:text-[11rem] leading-none font-serif uppercase text-royalGold/70 tracking-[0.5em] select-none whitespace-nowrap" data-text="RACHHA">
              RACHHA
            </span>
            ...
            <div className="relative z-10 rounded-[2rem] backdrop-blur-lg p-8 md:p-12 shadow-[0_25px_80px_-40px_rgba(0,0,0,0.25)]"> 
            ...
            <div className="font-sans font-normal tracking-[0.1em] text-lg space-y-8 text-center relative">
